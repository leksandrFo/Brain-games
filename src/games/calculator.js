...
const questionAndAnswer = () => {
  ...
  if (signOfExpression === '-') {// Условия на вычитание
    ...
    // Первое число не должно быть равно нулю и второму числу, а также второе число должно быть меньше первого, чтобы не уходить в отрицательные числа
  ...
  if (signOfExpression === '*') {
    ...
    // Первое число не должно быть равно нулю, а также одно из чисел не должно быть больше 10 для простоты подсчета
